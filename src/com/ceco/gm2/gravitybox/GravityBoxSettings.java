...
public class GravityBoxSettings extends Activity implements GravityBoxResultReceiver.Receiver {
    ...
    public static final String PREF_KEY_NAVBAR_CURSOR_CONTROL = "pref_navbar_cursor_control2";
        ...
        private void setDefaultValues() {
            ...
            if (sSystemProperties.uuidRegistered) {
                if ("PayPal".equals(sSystemProperties.uuidType)) {
                    ...
                    UnlockActivity.checkPolicyOk(getActivity(), new UnlockActivity.CheckPolicyHandler() {
                        @Override
                        public void onPolicyResult(boolean ok) {
                            if (ok) {
                                ...
                                if (cnt > 3) {
                                    SettingsManager.getInstance(getActivity()).resetUuid();
                                } else {
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            ...
            if (key.equals(PREF_KEY_BATTERY_STYLE)) {
                ...
                intent.putExtra(EXTRA_NAVBAR_CURSOR_CONTROL,
                        prefs.getString(PREF_KEY_NAVBAR_CURSOR_CONTROL, "DISABLED"));
                ...
                intent.putExtra(EXTRA_BBAR_COLOR, prefs.getInt(key, 
                        getResources().getInteger(R.integer.COLOR_HOLO_BLUE_DARK)));
