...
import com.ceco.lollipop.gravitybox.adapters.IIconCheckListAdapterItem;
import com.ceco.lollipop.gravitybox.adapters.IconCheckListAdapter;
        ...
        public Drawable getIconLeft() {
            ...
            if (mIcon == null) {
                ...
                if (!mPackage.equals("android") &&
                    ...
                    try {
                        ctx = mContext.createPackageContext(mPackage, 
                ...
                try {
                    Drawable d = ctx.getDrawable(mIconId);
                    if (d != null) {
