...
public class HeadsUpTile extends QsTile {
    ...
    protected HeadsUpTile(Object host, String key, XSharedPreferences prefs,
    ...
    public void handleUpdateState(Object state, Object arg) {
        ...
        mState.visible = true;
        mState.icon = mGbContext.getDrawable(mState.booleanValue ? R.drawable.ic_qs_heads_up_on :
