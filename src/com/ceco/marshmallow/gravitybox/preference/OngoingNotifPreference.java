...
import com.ceco.marshmallow.gravitybox.adapters.IIconCheckListAdapterItem;
import com.ceco.marshmallow.gravitybox.adapters.IconCheckListAdapter;
...
public class OngoingNotifPreference extends DialogPreference 
    ...
    class OngoingNotif implements IIconCheckListAdapterItem {
        ...
        public Drawable getIconLeft() {
            ...
            if (mIcon == null) {
                Context pkgContext = mContext;
                if (!mPackage.equals("android") &&
                        !mPackage.equals(mContext.getPackageName())) {
                    try {
                        pkgContext = mContext.createPackageContext(mPackage, 
                ...
                try {
                    Drawable d = pkgContext.getDrawable(mIconId);
                    if (d != null) {
