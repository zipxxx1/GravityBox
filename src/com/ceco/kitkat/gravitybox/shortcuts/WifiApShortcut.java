...
public class WifiApShortcut extends AShortcut {
    ...
    public Drawable getIconLeft() {
        return mResources.getDrawable(R.drawable.shortcut_wifi_ap);
    }
    ...
    protected ShortcutIconResource getIconResource() {
        return ShortcutIconResource.fromContext(mContext, R.drawable.shortcut_wifi_ap);
    }
