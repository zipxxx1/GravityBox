...
public class QuietHoursShortcut extends AShortcut {
    ...
    public String getText() {
        return mContext.getString(R.string.shortcut_quiet_hours_toggle);
    }

    @Override
    public Drawable getIconLeft() {
        return mResources.getDrawable(R.drawable.shortcut_quiet_hours);
    }
    ...
    protected ShortcutIconResource getIconResource() {
        return ShortcutIconResource.fromContext(mContext, R.drawable.shortcut_quiet_hours);
    }
