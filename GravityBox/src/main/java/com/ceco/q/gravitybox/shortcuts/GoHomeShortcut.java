...
public class GoHomeShortcut extends AShortcut {
    ...
    public static final String ACTION_DEFAULT_URI = "#Intent;action=gravitybox.intent.action.LAUNCH_ACTION;launchFlags=0x10008000;component=com.ceco.q.gravitybox/.shortcuts.LaunchActivity;S.action=gravitybox.intent.action.GO_HOME;S.prefLabel=GravityBox%20Actions%3A%20Go%20home;i.mode=1;S.label=Go%20home;S.iconResName=com.ceco.q.gravitybox%3Adrawable%2Fshortcut_home;S.actionType=broadcast;end";
